...
export function InsertImageUriDialogBody({
  ...
  onClickAction: (payload: InsertImagePayload) => void;
}) {
    ...
    <div className="grid gap-4 pt-4">
      ...
      <DialogFooter>
        <Button
          type="submit"
          disabled={isDisabled}
          onClick={() => onClickAction({ altText, src })}
  ...
  return (
    <Tabs defaultValue="url">
      ...
      <TabsContent value="url">
        <InsertImageUriDialogBody onClickAction={onClick} />
      </TabsContent>
      <TabsContent value="file">
        <InsertImageUploadedDialogBody onClickAction={onClick} />
      </TabsContent>
    </Tabs>
  );
}
