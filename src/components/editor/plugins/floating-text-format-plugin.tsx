...
function FloatingTextFormat({
  ...
  }, [editor, isLink, setIsLinkEditModeAction]);
  ...
  if (isUnderline) activeFormats.push("underline");
  if (isStrikethrough) activeFormats.push("strikethrough");
  if (isSubscript) activeFormats.push("subscript");
  if (isSuperscript) activeFormats.push("superscript");
  if (isCode) activeFormats.push("code");
  if (isLink) activeFormats.push("link");
  ...
  return (
    ...
    >
      {editor.isEditable() && (
        <>
          <ToggleGroup
            value={activeFormats} // Gunakan 'value' (Controlled), bukan 'defaultValue'
            onValueChange={() => {}}
          >
            <ToggleGroupItem
              value="bold"
