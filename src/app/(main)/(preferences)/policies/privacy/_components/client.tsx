...
import { useGetPrivacyPoliciesDetail, useUpdatePrivacyPolicies } from "../_api";
...
export const PrivacyPolicyClient = () => {
  const idFormPrivacyPolicy = useId();
  const [contentState, setContentState] = useState("id");
  const { data: detail, refetch, isRefetching } = useGetPrivacyPoliciesDetail();
  ...
  const { mutate: updatePrivacyPolicy, isPending: isUpdating } =
    useUpdatePrivacyPolicies();
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    updatePrivacyPolicy({ body: values }, { onSuccess: () => handleClose() });
  };
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  ...
                  >
                    <FieldLabel
                      required
                      htmlFor={`${idFormPrivacyPolicy}-${field.name}`}
                    >
                      Judul
                    </FieldLabel>
                    <InputGroup>
                      <InputGroupInput
                        {...field}
                        id={`${idFormPrivacyPolicy}-${field.name}`}
                        type="text"
                        aria-invalid={fieldState.invalid}
                        placeholder="Judul kebijakan privasi..."
                        autoComplete="off"
                      />
                      <InputGroupAddon>
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    ...
                    >
                      <div>
                        <Editor
                          placeholder="Konten kebijakan privasi..."
                          key={"id"}
