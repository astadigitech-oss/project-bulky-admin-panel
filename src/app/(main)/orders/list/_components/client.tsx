                ...
                <Command className="p-0">
                  <CommandGroup>
                    ...
                    <CommandItem className="text-xs">
                      <div
                        className={cn(
                          "flex h-4 w-4 items-center justify-center rounded-sm border border-gray-500/50 dark:border-gray-300 opacity-50 [&_svg]:invisible",
                        )}
                      >
                        <Check className="text-primary-foreground size-3" />
                      </div>
                ...
                <Command className="p-0">
                  <CommandGroup>
                    ...
                    <CommandItem className="text-xs">
                      <div
                        className={cn(
                          "mr-2 flex h-4 w-4 items-center justify-center rounded-sm border border-gray-500/50 dark:border-gray-300 opacity-50 [&_svg]:invisible",
                        )}
                      >
                        <Check className="text-primary-foreground size-3" />
                      </div>
              ...
              <PopoverTrigger
                render={
                  <button className="flex items-center border border-gray-300 dark:border-gray-300/50 border-dashed rounded-md h-8 hover:bg-yellow-200 dark:hover:bg-yellow-300/30 transition cursor-default group">
                    ...
                    <div
                      className={cn(
                        "text-xs font-medium rounded-sm mx-2 px-2 py-0.5 flex items-center justify-center flex-none",
                        "bg-yellow-200 dark:bg-yellow-300/30 dark:group-hover:bg-transparent",
                      )}
                    >
