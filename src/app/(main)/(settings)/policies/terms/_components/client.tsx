...
import { useGetTermPoliciesDetail, useUpdateTermPolicies } from "../_api";
...
export const TermsPolicyClient = () => {
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    updateTermPolicy({ body: values }, { onSuccess: () => handleClose() });
  };
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  ...
                  >
                    <FieldLabel
                      required
                      htmlFor={`${idFormTermPolicy}-${field.name}`}
                    >
                      Judul
                    </FieldLabel>
                    <InputGroup>
                      <InputGroupInput
                        {...field}
                        id={`${idFormTermPolicy}-${field.name}`}
                        type="text"
                        aria-invalid={fieldState.invalid}
                        placeholder="Judul syarat & ketentuan..."
                        autoComplete="off"
                      />
                      <InputGroupAddon>
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    ...
                    >
                      <div>
                        <Editor
                          placeholder="Konten syarat & ketentuan..."
                          key={"id"}
