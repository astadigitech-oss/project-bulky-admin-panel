...
import { useGetPaymentHelpDetail, useUpdatePaymentHelp } from "../_api";
...
export const PaymentHelpClient = () => {
  const idFormPaymentHelp = useId();
  const [contentState, setContentState] = useState("id");
  const { data: detail, refetch, isRefetching } = useGetPaymentHelpDetail();
  ...
  const { mutate: updatePaymentHelp, isPending: isUpdating } =
    useUpdatePaymentHelp();
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    updatePaymentHelp({ body: values }, { onSuccess: () => handleClose() });
  };
  ...
  return (
    <div className="flex flex-col gap-6 pt-4">
      <div className="flex items-center justify-between">
        <h1 className="leading-none font-semibold text-2xl">Cara Pembayaran</h1>
      </div>
      <div>
        <form
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  ...
                  >
                    <FieldLabel
                      required
                      htmlFor={`${idFormPaymentHelp}-${field.name}`}
                    >
                      Judul
                    </FieldLabel>
                    <InputGroup>
                      <InputGroupInput
                        {...field}
                        id={`${idFormPaymentHelp}-${field.name}`}
                        type="text"
                        aria-invalid={fieldState.invalid}
                        placeholder="Judul cara pembayaran..."
                        autoComplete="off"
                      />
                      <InputGroupAddon>
                  ...
                  >
                    <InputGroup>
                      <InputGroupInput
                        ...
                        type="text"
                        aria-invalid={fieldState.invalid}
                        placeholder="Payment guide title..."
                        autoComplete="off"
                      />
                      <InputGroupAddon>
                        <div className="rounded overflow-hidden size-4 flex items-center justify-center">
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    ...
                    >
                      <div>
                        <Editor
                          placeholder="Konten cara pembayaran..."
                          key={"id"}
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    ...
                    >
                      <div>
                        <Editor
                          placeholder="Payment guide content..."
                          key={"en"}
                          initialHtml={field.value}
                          onHtmlChangeAction={field.onChange}
                        />
