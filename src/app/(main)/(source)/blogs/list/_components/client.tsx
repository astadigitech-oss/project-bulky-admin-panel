...
import { useDeleteBlog, useGetBlogList, useToggleStatusBlog } from "../_api";
  ...
  return (
    <div className="flex flex-col gap-6 pt-4">
      ...
      <div className="flex items-center justify-between">
        <h1 className="leading-none font-semibold text-2xl">List Berita</h1>
        <div className="flex items-center gap-2">
          ...
          <Button
            className={"text-xs"}
            onClick={() => router.push("/blogs/list/create")}
            disabled={isDisabled}
          >
      ...
      <div className="flex flex-col gap-4">
        <DataTable
          columns={column({
            metaPage,
            disabled: isDisabled,
            handleEdit: (id) => router.push(`/blogs/list/${id}`),
            handleDelete,
            handleChangeStatus,
          })}
          data={list?.data ?? []}
