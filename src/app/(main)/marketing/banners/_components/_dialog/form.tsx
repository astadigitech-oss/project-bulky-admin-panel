...
// Rasio (width / height) area carousel banner di aplikasi mobile. Banner web
// pakai rasio ~4.2:1, sedangkan mobile app melakukan crop horizontal (tinggi
// tetap sama, sisi kiri-kanan terpotong secara center) sehingga rasionya
// jadi lebih "gemuk", sekitar ~3:1.
// TODO: sesuaikan angka ini bila rasio carousel mobile berubah.
const MOBILE_SAFE_AREA_RATIO = 3;
            ...
            <FieldGroup className="grid md:grid-cols-6 gap-4 max-h-[calc(100vh-200px)] overflow-y-auto overflow-x-hidden">
                  ...
                  render={({ field, fieldState }) => (
                    ...
                    >
                      ...
                      <Dropzone
                        ...
                        ratio="banner"
                        safeAreaRatio={MOBILE_SAFE_AREA_RATIO}
              ...
              <div className="col-span-full px-2 lg:px-3 py-2 border rounded-md flex text-xs items-start gap-2 bg-blue-50 dark:bg-blue-400/10 border-blue-200 dark:border-blue-300/30">
                ...
                <p className="text-blue-700 dark:text-blue-300">
                  Gunakan rasio <strong>~4.2:1</strong> — contoh: <strong>1276 × 302 px</strong> (atau 2x lipatnya <strong>2552 × 604 px</strong> untuk layar retina/HiDPI). Format JPG/PNG/<strong>WebP</strong>, maks 2MB. Area di dalam kotak kuning putus-putus pada preview adalah bagian yang tetap terlihat di aplikasi mobile — pastikan teks/logo penting berada di dalamnya.
                </p>
              </div>
              <Controller
                name="nama"
